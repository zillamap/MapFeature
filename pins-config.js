var pins_config = {
  "pins":[
  {
    ...
    "hover": "<b><u>TALLAHASSEE</u></b><br>Write any text and load images<br><img src='example.png'>",//info of the popup
    "pos_X": 349,//check the X, Y coordinates guide in the documentation
    "pos_Y": 94,
    "size": 23,//size of the pin
  ...
  {
    "shape": "circle",
    "hover": "<b><u>TEMPA</u></b><br><span style='color: #bcbcbc;'>Street Address:</span><br>&nbsp;321 Example, Address 54321<br><span style='color: #bcbcbc;'>Telephone:</span><br>&nbsp;(256) 555-4321 / (256) 555-1234",
    "pos_X": 519,
    "pos_Y": 383,
    "size": 24,
    "outline": "#660000",
  ...
  {
    "shape": "circle",
    "hover": "<b><u>JACKSONVILLE</u></b><br><span style='color: #999;'>Click to open a modal window!</span><br><span style='color: #ff6666;'><b>Modal Window Option is Compatible<br> with Bootstrap Only.</b></span>",
    "pos_X": 603,
    "pos_Y": 106,
    "size": 20,
    "outline": "#660000",
...
jQuery(function () {
  ...
  if(pins_len > 0) {
    ...
    var tsvg_obj = document.getElementById("usfljspins");
    ...
    for (var i = 0; i < pins_len; i++) {
      if (pins_config.pins[i].shape === "circle") {
        ...
        svg_circle.setAttributeNS(null, "id", "usfljspins_" + i);
        tsvg_obj.appendChild(svg_circle);
        usfljsAddEvent(i);
      }
        ...
        svg_rect.setAttributeNS(null, "id", "usfljspins_" + i);
        tsvg_obj.appendChild(svg_rect);
        usfljsAddEvent(i);
      }
    }
...
function usfljsAddEvent(id) {
  var obj = jQuery("#usfljspins_" + id);
  if(pins_config.pins[id].active === true){
    obj.attr({"cursor": "pointer"});
    obj.hover(function () {
      jQuery("#usfljstip").show().html(pins_config.pins[id].hover);
